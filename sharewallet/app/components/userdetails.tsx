export default function UserDetails({setOpen}:{setOpen:React.Dispatch<React.SetStateAction<boolean>>}){
    return(
        <div>
          ...
          <div className="bg-[#fafafa] p-6 rounded-2xl w-96  shadow-lg flex items-center justify-center flex-col gap-8">
            <div>
                ...
                <div className="w-96 h-80 border-[#dddddd] border rounded-2xl flex items-center justify-center flex-col gap-4">
